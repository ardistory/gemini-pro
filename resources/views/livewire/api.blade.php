    ...
    <div class="grid grid-cols-12 grid-rows-7 md:grid-rows-12 w-full gap-5 mt-20 mb-10 mx-5 md:mt-20">
        ...
        <div
            ...
            <div class="flex flex-col gap-2">
                <div class="flex gap-2">
                    ...
                    <span
                        ...
                        <p class="whitespace-nowrap text-sm">Text AI</p>
                    </span>
            ...
            <div class="flex flex-col gap-2">
                <div class="flex gap-2">
                    <span
                        class="w-auto whitespace-nowrap rounded-full bg-green-100 px-2.5 py-0.5 text-sm text-green-700">
                        POST
                    </span>
                    <span
                        class="inline-flex items-center justify-center rounded-full bg-amber-100 px-2.5 py-0.5 text-amber-700">
            ...
            <div class="flex flex-col gap-2">
                <div class="flex gap-2">
                    <span
                        class="w-auto whitespace-nowrap rounded-full bg-blue-100 px-2.5 py-0.5 text-sm text-blue-700">
                        GET
                    </span>
                    <span
                        class="inline-flex items-center justify-center rounded-full bg-amber-100 px-2.5 py-0.5 text-amber-700">
                        ...
                        <p class="whitespace-nowrap text-sm">Image AI</p>
                    </span>
                    <span class="whitespace-nowrap rounded-full bg-purple-100 px-2.5 py-0.5 text-sm text-purple-700">
                        : String Base64
                    </span>
        ...
        <div
            ...
            <div class="flex gap-2">
                <div class="border-t-[1.5px] px-3 py-2 rounded-lg bg-gradient-to-tr from-blue-500 to-blue-900">
                    <span
                        class="font-semibold before:w-12 before:h-12 before:bg-blue-500 before:absolute before:blur-[10px] before:rounded-full before:-z-50">GET</span>
                </div>
                <div class="border-t-[1.5px] px-3 py-2 rounded-lg bg-gradient-to-tr from-green-500 to-green-900">
                    <span
                        class="font-semibold before:w-12 before:h-12 before:bg-green-500 before:absolute before:blur-[10px] before:rounded-full before:-z-50">POST</span>
                </div>
            </div>
        </div>
    </div>
