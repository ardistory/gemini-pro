<div class="w-full min-h-screen flex flex-col md:flex-row justify-around items-center">
    ...
    <div
        ...
        <div
            class="before:absolute before:block before:w-96 before:h-96 before:bg-gradient-to-r before:from-blue-vite before:to-pink-vite before:-z-50 before:rounded-full before:blur-[120px] before:-translate-x-[0%] before:translate-y-[50%] md:before:translate-x-[7%] md:before:-translate-y-[15%]">
            <div
